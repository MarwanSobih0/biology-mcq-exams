...
st.markdown("""
    ...
    * {
    ...
    .stRadio label, .stRadio span, .stApp .css-1d391kg span {
        color: #0F172A !important;
        opacity: 1 !important;
    }
...
assignments = {
    ...
    "Assignment 5": [
        ...
        {"q": "10. Glucose crosses the cell membrane, while galactose, a very similar molecule, cannot. How can this be explained?", "options": ["a. membrane transporter is specific for glucose – galactose can't enter the transporter", "b. glucose is larger than galactose, so the receptor proteins bind glucose more effectively", "c. glucose gets through but galactose is blocked by osmosis"], "answer": "a"},
        {"q": "11. Which observation(s) would distinguish an active transport system from a passive system?", "options": ["a. transport rate was sensitive to temperature and pH", "b. transport rate declined when an inhibitor was used to prevent the hydrolysis of ATP", "c. transport rate is not dependent on the concentration gradient", "d. all of the choices would characterize active transport"], "answer": "d"},
        {"q": "12. Meals with a high salt content can temporarily cause blood plasma to become _____, and red blood cells to _____.", "options": ["a. hypotonic, shrink", "b. hypertonic, swell", "c. hypotonic, swell", "d. hypertonic, shrink"], "answer": "d"},
        {"q": "13. Why does a drop of food coloring diffuse more rapidly in warm water than in cold?", "options": ["a. collisions with rapidly moving water molecules disperse the food coloring more quickly", "b. warm food coloring expands, becomes less dense, and floats toward the surface", "c. temperature differences increase the steepness of the concentration gradient"], "answer": "a"},
        {"q": "14. Which of the following do enzymes and membrane carriers have in common?", "options": ["a. they recognize molecules by shape", "b. they are constructed from protein", "c. both choices are true"], "answer": "c"},
        {"q": "15. Which of the following would diffuse most easily across a cell membrane?", "options": ["a. carbon dioxide", "b. glucose", "c. glycogen"], "answer": "a"},
